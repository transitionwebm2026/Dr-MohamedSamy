...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="group relative flex size-14 items-center justify-center rounded-full bg-gradient-to-br from-[#3ee083] to-brand-whatsapp text-white shadow-[0_10px_35px_-8px_rgba(37,211,102,0.75)]"
    >
